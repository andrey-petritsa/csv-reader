...
Внутри проекта есть [csv файл пример](cli/employee.csv) сгенерированный заранее [модулем](src/csv/Fixture/FixtureGenerator.php) . Его можно прочитать
через [скрипт](/cli/GenerateCsvCommand.php). Вывод скрипта идет в stdout.
Для решения задачи использовались 
1. PSR-4
2. DTO шаблон проектирования
3. PSR-12
